...
class SettingsApp:
    ...
    def init_style(self):
        ...
        style.configure("TNotebook.Tab", background="#3a3a3a", foreground="white", padding=5)
        ...
        style.configure("TButton", background="#3a3a3a", foreground="white", relief="flat", borderwidth=0)
    ...
    def create_widgets(self):
        ...
        ttk.Label(threshold_frame, text='敌方匹配阈值:').grid(row=0, column=0, padx=5, pady=5, sticky=tk.W)
        ...
        ttk.Label(qb_basic, text='触发热键:').grid(row=0, column=0, padx=5, pady=5, sticky=tk.W)
        self.qb_hotkey = ttk.Entry(qb_basic)
        self.qb_hotkey.grid(row=0, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(qb_basic, text='执行按键:').grid(row=1, column=0, padx=5, pady=5, sticky=tk.W)
        self.qb_sendkey = ttk.Entry(qb_basic)
        self.qb_sendkey.grid(row=1, column=1, padx=5, pady=5, sticky=tk.W)

        ttk.Label(qb_basic, text='执行间隔(ms):').grid(row=2, column=0, padx=5, pady=5, sticky=tk.W)
        ...
        self.qb_windows = tk.Text(window_list, height=8, bg="#3a3a3a", fg="white", insertbackground="white", relief="flat")
